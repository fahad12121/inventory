            ...
            <div class="row gy-4 mb-4">
                ...
                <div class="col-xl-4">
                    <div class="card h-100">
                        ...
                        <img src="../../demo/assets/img/illustrations/trophy.png"
                            ...
                            <ul class="p-0 m-0">
                                <li class="d-flex mb-3">
                                    <div class="flex-shrink-0">
                                        <img src="../../demo/assets/img/icons/brands/facebook-rounded.png" alt="facebook"
                                ...
                                <li class="d-flex mb-3">
                                    <div class="flex-shrink-0">
                                        <img src="../../demo/assets/img/icons/brands/dribbble-rounded.png" alt="dribbble"
                                            class="me-3" height="34">
                                    </div>
                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                                ...
                                <li class="d-flex mb-3">
                                    <div class="flex-shrink-0">
                                        <img src="../../demo/assets/img/icons/brands/twitter-rounded.png" alt="facebook"
                                            class="me-3" height="34">
                                    </div>
                                    <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                        <div class="me-2">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3">
                                <p class="mb-0">Last month you had $2.42 expense transactions, 12 savings entries and 4
                                    bills.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="d-flex pt-3">
                                            <div class="px-2 rounded bg-lighter d-flex align-items-center h-px-30">
                                                <img src="../../demo/assets/img/icons/payments/logo-visa.png"
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <div class="px-2 rounded bg-lighter d-flex align-items-center h-px-30">
                                                <img src="../../demo/assets/img/icons/payments/logo-mastercard.png"
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <div class="px-2 rounded bg-lighter d-flex align-items-center h-px-30">
                                                <img src="../../demo/assets/img/icons/payments/logo-american-express.png"
