                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        ...
                                        <table class="table table-striped table-bordered" id="branchTabel">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>Name</th>
...
@section('scripts')
    <script>
        const editMember = (item) => {
            $('#myModalLabel1').text('Edit Branch');
            $('#id').val(item.id);
            $('#name').val(item.name);
        ...
        $(document).ready(function() {
            ...
            var table = $('#branchTabel').DataTable({
                    ...
                    .then((willDelete) => {
                        if (willDelete) {
                            ...
                            $.ajax({
                                type: "DELETE",
                                url: get_url(
                                    "{{ route('admin.branch.destroy', 'item_id') }}",
                                    delete_id),
                                data: data,
                                success: function(response) {
                                    if (response.status) {
